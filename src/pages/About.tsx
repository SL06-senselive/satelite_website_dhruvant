      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="container mx-auto px-4 py-12 md:py-20">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-senseLive-blue max-w-3xl mx-auto">
          ...
          {/* Company Story */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center text-senseLive-blue mb-8">Our Story</h2>
          ...
          {/* Team Section (Previously Fixed) */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center text-senseLive-blue mb-8">Leadership Team</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200 text-center text-senseLive-spaceBlack">
                ...
                <div className="p-6">
                  <h3 className="font-bold text-xl text-senseLive-blue mb-1">Abhijeet Bhoyar</h3>
                  <p className="text-senseLive-lightBlue mb-3">Chief Organizing Officer (COO)</p>
                  <p className="text-sm">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200 text-center text-senseLive-spaceBlack">
                ...
                <div className="p-6">
                  <h3 className="font-bold text-xl text-senseLive-blue mb-1">Piyush Charpe</h3>
                  <p className="text-senseLive-lightBlue mb-3">Chief Executive Officer (CEO)</p>
                  <p className="text-sm">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200 text-center text-senseLive-spaceBlack">
                ...
                <div className="p-6">
                  <h3 className="font-bold text-xl text-senseLive-blue mb-1">Mayur Dafare</h3>
                  <p className="text-senseLive-lightBlue mb-3">Chief Technology Officer (CTO)</p>
                  <p className="text-sm">
          ...
          <div>
            <h2 className="text-3xl font-bold text-center text-senseLive-blue mb-8">Our Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <div className="w-12 h-12 bg-senseLive-teal/50 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-senseLive-darkTeal" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                  </svg>
                </div>
                <h3 className="font-bold text-xl text-senseLive-blue mb-2">Reliability</h3>
                <p className="text-senseLive-spaceBlack text-sm">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <div className="w-12 h-12 bg-senseLive-blue/50 rounded-full flex items-center justify-center mb-4">
                ...
                <h3 className="font-bold text-xl text-senseLive-blue mb-2">Innovation</h3>
                <p className="text-senseLive-spaceBlack text-sm">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <div className="w-12 h-12 bg-senseLive-purple/50 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-senseLive-darkPurple" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                  </svg>
                </div>
                <h3 className="font-bold text-xl text-senseLive-blue mb-2">Customer Focus</h3>
                <p className="text-senseLive-spaceBlack text-sm">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <div className="w-12 h-12 bg-senseLive-orange/50 rounded-full flex items-center justify-center mb-4">
                ...
                <h3 className="font-bold text-xl text-senseLive-blue mb-2">Global Impact</h3>
                <p className="text-senseLive-spaceBlack text-sm">
